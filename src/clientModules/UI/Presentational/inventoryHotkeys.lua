    ...
    return e("Frame", {
        ...
        DraggableArea = e(draggable, {
            ...
            onDragReleased = function()
                local dir = (props.ref:getValue().Parent.Parent.AbsolutePosition - props.ref:getValue().Parent.AbsolutePosition).Unit
                if dir.X ~= dir.X then
            ...
            Button = e(isButton and "TextButton" or "TextLabel", {
                ...
                Charge = e("Frame", {
                    ...
                    Size = UDim2.new(1, -HUDConstants.HUD_PADDING, 0, (ITEM_SIZE - HUDConstants.HUD_PADDING) * props.charge);
