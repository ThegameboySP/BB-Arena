...
local function textBox(props, hooks)
    ...
    hooks.useEffect(function()
        ...
        local function updateTextboxSize()
            local textBounds = TextService:GetTextSize(textbox.Text, props.textSize, Enum.Font.Gotham, textMaxScreenSpace)
	...
	return e("ImageLabel", {
        ...
        ScrollingFrame = e("ScrollingFrame", {
            ...
            TextBox = e(props.inactive and "TextLabel" or "TextBox", {
                ...
                [Roact.Event.FocusLost] = if props.inactive then nil else function()
                    local textbox = self.textboxRef:getValue()
