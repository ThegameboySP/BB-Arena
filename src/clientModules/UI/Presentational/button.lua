...
local function button(props, hooks)
    ...
    return e(props.inactive and "ImageLabel" or "ImageButton", {
        ...
        ImageColor3 =
            if props.inactive then props.color:Lerp(theme.inactive, 0.6)
        ...
        [Roact.Event.MouseEnter] = if props.inactive then nil else function()
            api.start({
                hover = 1;
                config = { tension = 600 };
            })
        ...
        [Roact.Event.MouseLeave] = if props.inactive then nil else function()
            api.start({
                hover = 0;
                config = { tension = 600 };
            })
        ...
        TouchRipple = if props.inactive then nil else e(touchRipple, {
